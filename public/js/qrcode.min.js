...
!(function () {
  ...
  (r.prototype = {
    ...
    (h.prototype = {
      ...
      setupPositionAdjustPattern: function () {
        for (
          var t = _.getPatternPosition(this.typeNumber), e = 0;
          e < t.length;
          e++
        )
    ...
    (h.createData = function (t, e, r) {
      ...
      for (
        ...
        !(
          ...
          (i.put(h.PAD0, 8), i.getLengthInBits() >= 8 * s)
        );
    ...
    (h.createBytes = function (t, e) {
      for (
        ...
        r += h;
        var d = _.getErrorCorrectPolynomial(l),
          g = new v(n[s], d.getLength() - 1).mod(d);
      ...
      var p = new Array(c),
        m = 0;
      for (u = 0; u < o; u++)
        for (s = 0; s < e.length; s++) u < n[s].length && (p[m++] = n[s][u]);
      for (u = 0; u < i; u++)
  ...
  var e,
    ...
    b =
      (((e = function (t, e) {
        ...
        var n = i("svg", {
          viewBox:
            "0 0 " + String(o + 2 * e.border) + " " + String(o + 2 * e.border),
          width: "100%",
          height: "100%",
          fill: e.colorLight
        });
    ...
    L =
      "svg" === document.documentElement.tagName.toLowerCase()
        ...
        ? (((D = function (t, e) {
            ...
            for (s = 0; s < o; s++) {
              for (a.push("<tr>"), h = 0; h < e.border; h++)
                a.push(
                  '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                    i +
                    "px;height:" +
            ...
            for (s = 0; s < e.border; s++) {
              for (a.push("<tr>"), h = 0; h < o + 2 * e.border; h++)
                a.push(
                  '<td style="border:0;border-collapse:collapse;padding:0;margin:0;width:' +
                    i +
                    "px;height:" +
            ...
            var l = r.childNodes[0],
              ...
              d = (e.height - l.offsetHeight) / 2;
            0 < u && 0 < d && (l.style.margin = d + "px " + u + "px");
          }),
            ...
            return (
              (e.prototype.draw = function (t) {
                var e = this._elImage,
                  ...
                  o = this._htOption,
                  i = t.getModuleCount(),
                  n = o.width / (i + 2 * o.border),
                  a = o.height / (i + 2 * o.border),
                  s = o.border * n,
                  h = o.border * a,
                  l = Math.round(n),
                  u = Math.round(a);
                (e.style.display = "none"),
                  this.clear(),
                  (r.strokeStyle = o.colorLight),
                  (r.lineWidth = 1),
                  (r.fillStyle = o.colorLight),
                  r.fillRect(0, 0, o.width, h),
                  r.fillRect(0, o.height - h, o.width, o.height),
                  r.fillRect(0, h, s, o.height - h),
                  r.fillRect(o.width - s, h, o.width, o.height - h);
                for (var d = 0; d < i; d++)
                  for (var g = 0; g < i; g++) {
                    var f = t.isDark(d, g),
                      c = g * n,
  ...
  ((QRCode = function (t, e) {
    ...
    (this._oQRCode = new h(
      y(t, this._htOption.correctLevel),
